...
(function () {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE && */
  ...
  var L = function (a, b, c) {
      ...
      b && b.length > 0 && (b = M(b), c && c.length > 0 && (b += '___' + M(c)), b.length > 28 && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = x(ha, '_p', y()), x(b, c, y())[a] = (new Date()).getTime(), L(a, '_p', c))
    }, M = function (a) {
  ...
  var ia = /^(\/[a-zA-Z0-9_\-]+)+$/, T = [/\/amp\//, /\/amp$/, /^\/amp$/], ja = /^[a-zA-Z0-9\-_\.,!]+$/,
    ka = /^gapi\.loaded_[0-9]+$/, la = /^[a-zA-Z0-9,._-]+$/, pa = function (a, b, c, d) {
      ...
      b = k
      c = b.match(ma);
      (d = b.match(na)) && d.length === 1 && oa.test(b) && c && c.length === 1 || S('failed sanity: ' + a)
      return k
    }, ra = function (a, b, c, d) {
      a = qa(a)
      ...
      for (var b = a.substring(1).split('/'), c = []; b.length;) {
        a = b.shift()
        if (!a.length || a.indexOf('.') == 0) S('empty/relative directory'); else if (a.indexOf('=') > 0) {
          b.unshift(a)
          break
        }
        c.push(a)
...
gapi.load('', {
  ...
  _c: {
    'jsl': {
      ...
      'h': 'm;/_/scs/apps-static/_/js/k\u003doz.gapi.de.9PLrQxDQ8MY.O/am\u003dwQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPEKt4eEd7atxHMkfrGOLVsKVkd3g/m\u003d__features__',
